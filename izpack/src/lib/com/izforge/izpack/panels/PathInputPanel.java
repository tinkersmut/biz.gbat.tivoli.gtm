...
public class PathInputPanel extends IzPanel implements ActionListener {
	...
	public PathInputPanel(InstallerFrame parent, InstallData idata) {
		...
		// Label for input
		// row 1 column 0.
		add(createLabel("info", "TargetPanel", "open", LEFT, true), NEXT_LINE);
	...
	public boolean isValidated() {
		...
		if (modifyinstallation) {
			// installation directory has to exist in a modification
			// installation
			mustExist = true;
		...
		if (isMustExist()) {
			...
			// This is an annoying popup so changing this to
			// *****moded by gadams,
