...
public class UserInputPanel extends IzPanel implements ActionListener, ItemListener, FocusListener
{
        ...
        if (element != null)
        {
            ...
            for (int i = 0; i < choices.size(); i++)
            {
                ...
                if (causesValidataion != null && causesValidataion.equals("yes"))
                {
                    ...
                    choice.setActionCommand("highlightRadioButton");
                }
                ...
                if (set != null)
                {
                    ...
                    {
                        choice.setSelected(true);
                        choice.setForeground(new Color(0, 153, 51));
                        choice.setFont(new Font(choice.getFont().getFamily(),Font.BOLD,choice.getFont().getSize()));
                    }
                }
    ...
    private class SearchField implements ActionListener
    {
        ...
        public void actionPerformed(ActionEvent event)
        {
            ...
            else if (event.getActionCommand().equals("highlightRadioButton")){
